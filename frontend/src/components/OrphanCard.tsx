            ...
            <div className="p-6">
                ...
                <div className="mt-4 pt-4 border-t border-gray-100 flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-lg font-bold text-teal-600">{budget.toLocaleString()} ريال</p>
                    </div>
                    <button className="px-4 py-2 bg-gray-50 text-teal-700 font-medium rounded hover:bg-teal-50 transition-colors">
                        التفاصيل
                    </button>
                </div>
            </div>
